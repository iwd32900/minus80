...
while true; do
    ...
    find ~/Pictures/*.photoslibrary/{Masters,Previews} '(' -iname '*.jpg' -or -iname '*.heic' -or -iname '*.mov' ')' -mtime +14 | /Users/ian/miniconda3/bin/python3 ./minus80.py archive config.json
